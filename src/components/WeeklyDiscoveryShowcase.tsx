...
export const WeeklyDiscoveryShowcase: React.FC<WeeklyDiscoveryShowcaseProps> = ({
  ...
  return (
    <section className="relative overflow-hidden bg-white dark:bg-[#131926] border border-slate-200 dark:border-slate-800 rounded-3xl p-6 sm:p-8 lg:p-10 shadow-xl text-slate-900 dark:text-white transition-colors">
      ...
      <div className="relative grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center">
        ...
        <div className="lg:col-span-6 space-y-5 text-left">
          {/* Badge de Curadoria */}
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-xs font-bold bg-amber-500/15 text-amber-700 dark:text-amber-300 border border-amber-500/30 shadow-xs">
          ...
          <div>
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-serif font-bold text-slate-900 dark:text-white tracking-tight leading-tight">
              {livroDestaque.titulo}
            </h1>
            <p className="text-sm sm:text-base text-amber-600 dark:text-amber-400 font-medium mt-2 flex items-center gap-2">
              <span>por</span>
          ...
          <div className="flex flex-wrap items-center gap-3 pt-2">
            <button
              ...
              className="flex items-center gap-2 px-5 py-3 rounded-2xl text-xs sm:text-sm font-bold bg-amber-500 hover:bg-amber-400 text-slate-950 shadow-lg hover:shadow-amber-500/20 transition-all active:scale-95 cursor-pointer"
            >
